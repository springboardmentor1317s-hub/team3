    ...
    <div>
      ...
      <div className="event-section">
        <div className="event-card">
          <h3>Hackathons</h3>
          <p>
            24-hour innovation marathons where brilliant minds code solutions to
            real-world problems.
          </p>
        ...
        <div className="event-card">
          ...
          <p>
            High-energy competitions across cricket, football, and athletics.
        ...
        <div className="event-card">
          ...
          <p>
            Celebrate creativity through music, dance, art, and theater. Your
            stage awaits.
          </p>
